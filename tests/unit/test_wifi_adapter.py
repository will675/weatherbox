...
class TestWifiNetwork:
    ...
    def test_wifi_network_creation(self):
        ...
        network = WifiNetwork(ssid="TestNet", signal_strength=75, security="WPA2")
    ...
    def test_wifi_network_repr(self):
        ...
        network = WifiNetwork(ssid="MyNet", signal_strength=80, security="WPA2")
...
class TestWifiStatus:
    ...
    def test_wifi_status_creation(self):
        ...
        status = WifiStatus(connected=True, ssid="Connected", ip_address="192.168.1.100")
...
class MockWifiAdapter(WifiAdapter):
    ...
    def status(self):
        """Return mock status."""
        return WifiStatus(connected=True, ssid="TestNet1", ip_address="192.168.1.50")
...
class TestErrorHandling:
    ...
    def test_connect_with_special_characters_in_ssid(self):
        ...
        class SpecialCharsAdapter(WifiAdapter):
            def scan(self, timeout_seconds=10):
                return [WifiNetwork(ssid='Net "with" quotes', signal_strength=50, security="WPA2")]
            def connect(self, ssid, password, timeout_seconds=30):
