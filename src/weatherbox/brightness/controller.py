...
class BrightnessController:
    ...
    def __init__(
        ...
        day_brightness: Optional[int] = None  # Optional explicit day brightness
    ):
        """
        ...
        if self.sensor_adapter:
            try:
                ...
                if sensor_value is not None:
                    ...
                    logger.debug(f"Sensor adjusted brightness: {sensor_value} → {brightness}")
    ...
    def set_night_mode_brightness(self, brightness: int) -> None:
        ...
        logger.info(f"Night mode brightness updated to {self.night_mode_brightness}")
