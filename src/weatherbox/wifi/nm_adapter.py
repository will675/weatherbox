...
class NetworkManagerAdapter(WifiAdapter):
    ...
    def _connect_nmcli(self, ssid: str, password: str, timeout_seconds: int) -> bool:
    ...
    def _connect_python_nm(self, ssid: str, password: str, timeout_seconds: int) -> bool:
        ...
        try:
            ...
            logger.warning("python-networkmanager connection not fully implemented")
            return False
        except Exception as e:
    ...
    def disconnect(self) -> bool:
        ...
        try:
            if self.use_nmcli:
                ...
                logger.warning("Disconnect not implemented for python-networkmanager")
                return False
        except Exception as e:
