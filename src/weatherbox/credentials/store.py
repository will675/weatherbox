...
class CredentialStore:
    ...
    def __init__(self, credential_file_path: str, enable_encryption: bool = False):
        """
    ...
    def save_credentials(self, ssid: str, password: str, security_type: str = "WPA2") -> bool:
        """
        ...
        try:
            ...
            logger.info(f"Credentials saved to {self.credential_file_path} with mode 0o600")
            return True
    ...
    def load_credentials(self) -> Optional[Tuple[str, str]]:
        ...
        try:
            ...
            if file_mode != self.DEFAULT_FILE_MODE:
                logger.warning(
                    f"Credential file has insecure permissions: 0o{file_mode:o} "
                    f"(expected 0o{self.DEFAULT_FILE_MODE:o})"
                )
    ...
    def ensure_secure_permissions(self) -> bool:
        ...
        try:
            ...
            os.chmod(self.credential_file_path, self.DEFAULT_FILE_MODE)
            logger.info(f"Verified/corrected credential file permissions to 0o600")
            return True
        except Exception as e:
